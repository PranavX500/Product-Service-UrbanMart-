...
public class KafkaConfig {
    ...
    public ConsumerFactory<String, ListSuccessEvent> listSuccessConsumerFactory() {
        ...
        config.put(
                ...
                "com.example.Product_Service.DTO"
        );
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, ListSuccessEvent>
    ...
    @Bean
    public ProducerFactory<String, ProductResponseEvent>
            productResponseProducerFactory() {
        Map<String, Object> config = new HashMap<>();
    ...
    @Bean
    public KafkaTemplate<String, ProductResponseEvent>
            productResponseKafkaTemplate() {
    ...
    public DefaultErrorHandler kafkaErrorHandler(
            final KafkaTemplate<Object, Object> genericKafkaTemplate
    ) {
